...
<article class="card card--1">
  ...
  <div class="card__info">
    ...
    <h3 class="card__title">inavolu</h3>
...
<article class="card card--2">
  ...
  <div class="card__info">
    <span class="card__category">Surya Hostel</span>
    <h3 class="card__title">inavolu</h3>
...
<article class="card card--4">
  ...
  <div class="card__info">
    <span class="card__category"> MH Hostel</span>
    <h3 class="card__title">mandadam</h3>
...
<article class="card card--5">
  ...
  <div class="card__info">
    <span class="card__category"> Amma mens hostal</span>
    <h3 class="card__title">mndadam</h3>
...
<article class="card card--6">
  ...
  <div class="card__info">
    <span class="card__category"> MH Hostel</span>
    <h3 class="card__title">vijawada</h3>
...
<article class="card card--7">
  ...
  <div class="card__info">
    <span class="card__category"> MH Hostel</span>
    <h3 class="card__title">guntur</h3>
...
<article class="card card--8">
  ...
  <div class="card__info">
    <span class="card__category"> MH Hostel</span>
    <h3 class="card__title">thullur</h3>
